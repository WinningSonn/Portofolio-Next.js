...
const Modal = ({ onClose, toggle }) => {
  return createPortal(
    <div className="fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center z-20">
      <div
        className="bg-background/20 border border-purple-700/30 border-solid backdrop-blur-[6px]
      ...
      >
        ...
        <div className="flex items-center justify-center space-x-4">
          <button
            onClick={toggle}
            className="px-4 py-2 border border-purple-700/30 border-solid hover:shadow-glass-sm rounded mr-2"
          >
            Yes
          </button>
          <button
            onClick={onClose}
            className="px-4 py-2 border border-purple-700/30 border-solid hover:shadow-glass-sm rounded"
          >
            No
          </button>
        </div>
